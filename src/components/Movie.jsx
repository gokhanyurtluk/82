...
const Movie = (props) => {
  ...
  const isFavorites = useSelector(store => store.favoritesReducer.favorites.includes(movie));
  const showAddToFavorites = useSelector(store => store.favoritesReducer.displayFavorites);
